...
GPIO_PinConfig gpioPinConfigs[] = {
    /* CONFIG_GPIO_BLUE_LED : LaunchPad LED 2 Blue */
    GPIOMSP432_P2_2 | GPIO_CFG_OUT_STD | GPIO_CFG_OUT_STR_MED | GPIO_CFG_OUT_LOW,
    /* CONFIG_GPIO_BUTTON_S1 : LaunchPad Button S1 (Left) */
 ...
 */
extern void GPIO_Callback_Button_S1(uint_least8_t index);

GPIO_CallbackFxn gpioCallbackFunctions[] = {
    /* CONFIG_GPIO_BLUE_LED : LaunchPad LED 2 Blue */
    NULL,
    /* CONFIG_GPIO_BUTTON_S1 : LaunchPad Button S1 (Left) */
    GPIO_Callback_Button_S1,
};
